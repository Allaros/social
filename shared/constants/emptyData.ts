...
export const EMPTY = {
   ...
   emptyNotifications: {
      ...
      description: 'За последнее время ничео не происходило...',
   },
   emptyRelations: {
      title: 'Здесь никого...',
      description:
         'Похоже, что вы пока ни на кого не подписывались и никто не подписывался на вас, но это легко исправить!',
   },
   emptyChats: {
      title: 'Чатов пока нет',
      description: 'Напишите кому-нибудь, и диалог останентся тут',
   },
   emptyMessage: {
      title: 'Напишите что-нибудь или отправьте файл',
      description: 'Здесь будут отображаться сообщения данного диалога',
   },
};
